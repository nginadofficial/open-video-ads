...
package org.openvideoads.vast.schedule {
	...
	public class StreamConfig extends Debuggable {
		...
		public function StreamConfig(filename:String, duration:String, reduceLength:Boolean=false, deliveryType:String="any", playOnce:Boolean=false, metaData:Boolean=true, autoPlay:Boolean=true, provider:String=null, playerConfig:Object=null) {
