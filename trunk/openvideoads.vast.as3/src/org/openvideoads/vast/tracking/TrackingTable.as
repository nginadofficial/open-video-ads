...
package org.openvideoads.vast.tracking {
	...
	public class TrackingTable extends Debuggable {
	    ...
	    public function setPoint(trackingPoint:TrackingPoint, isChildLinear:Boolean=false):void {
	    	_points[_points.length] = { point:trackingPoint, hit:false, childLinear:isChildLinear };
			doLog("Tracking point recorded in table at " + trackingPoint.milliseconds + " milliseconds with event label " + trackingPoint.label, Debuggable.DEBUG_TRACKING_TABLE);	    	
	    }
