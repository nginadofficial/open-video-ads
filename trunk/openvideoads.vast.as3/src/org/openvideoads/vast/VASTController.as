...
package org.openvideoads.vast {
	...
	public class VASTController extends EventController implements TemplateLoadListener {
		...
		public function autoStart():Boolean {
        ...
        public function get playContiguously():Boolean {
        	return _config.playContiguously;
        }
		...
		public function createXSPFPlaylist():XSPFPlaylist {
			return PlaylistController.createPlaylist(_streamSequence, PlaylistController.PLAYLIST_FORMAT_XSPF) as XSPFPlaylist;
		}
		...
		public function processPopupVideoAdTimeEvent(associatedStreamIndex:int, timeEvent:TimeEvent, playingOverlayVideo:Boolean=false):void {
