...
package org.openvideoads.vast.schedule.ads.templates {
	...
	public class HtmlAdTemplate extends AdTemplate  {
		public static var DEFAULT_HTML_TEMPLATE:String = "<body>_code_</body>";
		
		public function HtmlAdTemplate(template:String=null) {
			super((template != null) ? template : DEFAULT_HTML_TEMPLATE);
		}
	}
}