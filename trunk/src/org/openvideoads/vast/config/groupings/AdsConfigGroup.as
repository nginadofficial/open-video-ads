...
package org.openvideoads.vast.config.groupings {
	...
	public class AdsConfigGroup extends AbstractStreamsConfig {
		...
		public function set notice(notice:Object):void {
			...
			if(notice.show != undefined) _noticeConfig.show = notice.show;
			if(notice.message != undefined) _noticeConfig.message = notice.message;
			if(notice.region != undefined) _noticeConfig.region = notice.region;
		}
